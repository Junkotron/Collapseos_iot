...
#ifndef __Z80USER_OLD_INCLUDED__
#define __Z80USER_OLD_INCLUDED__
...
{                                                                       \
  (x) = ((ZEXTEST *) context)->rom[(address) & 0xffff];			\
}
...
static unsigned char z80_read_byte(ZEXTEST* context, unsigned short address)		
{
  unsigned char x;
